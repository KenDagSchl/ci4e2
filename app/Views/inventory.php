<html>
    ...
    <body>
        ...
        */
        ?>
        <!-- Wrap the header and the "Add" button in a div with padding -->
        <br>
        <br>
        <div class="p-3">
            <div class="text-center">
                <h1>Admin Product Management Page</h1>
            </div>
            ...
            <div style="text-align: right; margin-bottom: 0px;">
                <a href="<?= base_url('/home/add') ?>" class="btn btn-secondary" style="margin-right: 10px;">Add</a>
            </div>
        </div>  

        <!-- Wrap the table in a div with padding -->
<div class="p-4">
