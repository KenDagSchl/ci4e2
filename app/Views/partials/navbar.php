        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="<?= base_url('/home/home') ?>"><img width="150" src="<?= base_url('homefile/images/logo.png') ?>" alt="#" /></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('/customization/table') ?>">Customize</a>
                            </li>
                            <li class="nav-item">
